...
public sealed class SupportToolsServerApiClient : ApiClient
{
    ...
    public ValueTask<Result> UploadGitRepos(SyncGitRequest gits,
    ...
    public Task<Result<StsGitDataModel>> GetGitRepoByKey(string gitKey,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result> RemoveGitRepoByKey(string gitKey,
        CancellationToken cancellationToken = default)
    {
